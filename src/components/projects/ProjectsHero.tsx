 ...
 *
 * Layout on the canvas: headline column down the left at x44, the category deck
 * on the right centred at y400, and the impact strip along the base at y731, both on the
 * site-wide 44/1576 content edge the header sets.
  ...
  return (
    <section ref={root} style={stageStyle} className={sectionClass}>
      <div style={scale} className={stageClass}>
        {/* ---------- headline column ---------- */}
        <div className="ph-head flex items-center gap-[14px] pt-16 lg:absolute lg:left-[calc(44*var(--s))] lg:top-[calc(195*var(--s))] lg:z-[3] lg:gap-[calc(14*var(--s))] lg:pt-0">
        ...
        <h1 className="ph-head mt-6 text-[clamp(2.5rem,11vw,80px)] font-extrabold leading-[1.04] tracking-[-0.032em] lg:absolute lg:left-[calc(42*var(--s))] lg:top-[calc(225*var(--s))] lg:z-[3] lg:mt-0 lg:text-[calc(64*var(--s))] lg:leading-[calc(68*var(--s))]">
          Systems that
          <br />
          create impact<span className="text-[hsl(var(--yellow))]">.</span>
        </h1>

        <p className="ph-head mt-6 max-w-[440px] text-[17px] leading-[1.5] text-[hsl(var(--ink-2))] lg:absolute lg:left-[calc(44*var(--s))] lg:top-[calc(405*var(--s))] lg:z-[3] lg:mt-0 lg:w-[calc(400*var(--s))] lg:max-w-none lg:text-[calc(20*var(--s))] lg:leading-[calc(30*var(--s))]">
          A curated collection of digital products, platforms and systems built
          to solve real business problems.
        </p>

        {/* projects-delivered card — canvas 44,548 · 333x138 */}
        <div
          style={{
          ...
          className="ph-delivered glass-card mt-8 w-full max-w-[360px] rounded-[22px] lg:absolute lg:left-[calc(44*var(--s))] lg:top-[calc(548*var(--s))] lg:z-[3] lg:mt-0 lg:h-[calc(138*var(--s))] lg:w-[calc(333*var(--s))] lg:max-w-none lg:rounded-[calc(22*var(--s))] lg:[transform:translate(calc(var(--px,0)*2px),calc(var(--py,0)*2px))]"
        >
        ...
        {/* ---------- impact strip — canvas 44,731 · 1532x112 ----------
        ...
        <div
          ...
          className="ph-strip glass-card glass-panel-static mt-10 rounded-[22px] lg:absolute lg:left-[calc(44*var(--s))] lg:top-[calc(731*var(--s))] lg:z-[3] lg:mt-0 lg:h-[calc(112*var(--s))] lg:w-[calc(1532*var(--s))] lg:rounded-[calc(26*var(--s))]"
        >
