  ...
  return (
    <section style={stageStyle} className={sectionClass}>
      <div style={scale} className={stageClass}>
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 bottom-[-30px] hidden select-none text-center font-extrabold leading-none tracking-[0.04em] text-[rgba(17,17,17,0.035)] lg:block lg:bottom-[calc(-30*var(--s))] lg:text-[calc(300*var(--s))]"
        >
          THINK
        </div>

        {/* ---------- left column ---------- */}
        <div className="flex items-center gap-[16px] lg:absolute lg:left-[calc(70*var(--s))] lg:top-[calc(150*var(--s))] lg:z-[5] lg:gap-[calc(16*var(--s))]">
        ...
        <h2 className="mt-6 text-[clamp(3rem,15vw,110px)] font-extrabold uppercase leading-[0.9] tracking-[-0.03em] lg:absolute lg:left-[calc(62*var(--s))] lg:top-[calc(190*var(--s))] lg:z-[5] lg:mt-0 lg:text-[calc(92*var(--s))]">
          How
          <br />I Think<span className="text-[hsl(var(--yellow))]">.</span>
        </h2>

        <p className="mt-6 max-w-[420px] text-[19px] leading-[1.45] text-[hsl(var(--ink-2))] lg:absolute lg:left-[calc(66*var(--s))] lg:top-[calc(390*var(--s))] lg:z-[5] lg:mt-0 lg:w-[calc(300*var(--s))] lg:max-w-none lg:text-[calc(19*var(--s))]">
        ...
        <div className="mt-12 lg:absolute lg:left-[calc(8*var(--s))] lg:top-[calc(-43*var(--s))] lg:mt-0 lg:h-[calc(1080*var(--s))] lg:w-[calc(1620*var(--s))] lg:origin-top-left lg:[transform:scale(0.835)]">
          ...
          >
            <g
              ...
              strokeLinecap="round"
            >
              <path d="M892,332 L892,372" />
              <path d="M892,332 L892,344 Q892,352 884,352 L662,352 Q654,352 654,360 L654,372" />
              <path d="M892,332 L892,344 Q892,352 900,352 L1132,352 Q1140,352 1140,360 L1140,372" />
              <path d="M750,463 L796,463" />
              <path d="M988,463 L1044,463" />
              <path d="M892,554 L892,580" />
              <path d="M654,554 L654,568 Q654,580 666,580 L884,580" />
              <path d="M1140,554 L1140,568 Q1140,580 1128,580 L900,580" />
              <path d="M892,580 L892,606" />
              <path d="M654,606 L654,594 Q654,580 666,580" />
              <path d="M1140,606 L1140,594 Q1140,580 1128,580" />
              <path d="M892,788 L892,828" />
            </g>
            <g
            ...
            <g fill="#f6f23c" stroke="rgba(17,17,17,0.25)" strokeWidth="1">
              <circle cx="750" cy="463" r="5" />
              <circle cx="988" cy="463" r="5" />
              <circle cx="654" cy="372" r="5" />
              <circle cx="1140" cy="372" r="5" />
            </g>
          </svg>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:contents">
            {nodes.map((node) => (
              <div
                key={node.n}
                className={`relative px-[18px] pb-[16px] pt-[34px] text-center ${nodeFace} lg:absolute lg:left-[var(--x)] lg:top-[var(--y)] lg:z-[3] lg:h-[calc(182*var(--s))] lg:w-[calc(192*var(--s))] lg:rounded-[calc(20*var(--s))] lg:px-[calc(18*var(--s))] lg:pb-[calc(16*var(--s))] lg:pt-[calc(34*var(--s))]`}
                style={{
