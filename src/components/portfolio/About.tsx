  ...
  return (
    <section style={stageStyle} className={sectionClass}>
      <div style={scale} className={stageClass}>
        {/* ---------- left column ---------- */}
        <div className="flex items-center gap-[14px] lg:absolute lg:left-[calc(116*var(--s))] lg:top-[calc(140*var(--s))] lg:z-[5] lg:gap-[calc(14*var(--s))]">
          <span className="h-[3px] w-[31px] rounded-[2px] bg-[hsl(var(--yellow))] lg:w-[calc(31*var(--s))]" />
        ...
        <h2 className="mt-6 text-[clamp(2.25rem,9vw,67px)] font-extrabold leading-[0.96] tracking-[-0.03em] lg:absolute lg:left-[calc(119*var(--s))] lg:top-[calc(195*var(--s))] lg:z-[5] lg:mt-0 lg:text-[calc(67*var(--s))] lg:leading-[calc(64*var(--s))]">
          ...
          Problem Solver.
          <br />
          <span className="text-[hsl(var(--yellow))]">System Builder.</span>
        </h2>

        <p className="mt-6 max-w-[460px] text-[17px] leading-[1.5] text-[hsl(var(--ink-2))] lg:absolute lg:left-[calc(117*var(--s))] lg:top-[calc(416*var(--s))] lg:z-[5] lg:mt-0 lg:w-[calc(440*var(--s))] lg:max-w-none lg:text-[calc(18*var(--s))] lg:leading-[calc(26*var(--s))]">
        ...
        {/* ---------- portrait card ---------- */}
        <div className="relative mt-10 h-[320px] overflow-hidden rounded-[28px] border border-[var(--glass-border)] bg-[hsl(var(--beige-2))] shadow-[var(--shadow)] sm:h-[420px] lg:absolute lg:left-[calc(773*var(--s))] lg:top-[calc(98*var(--s))] lg:z-[2] lg:mt-0 lg:h-[calc(510*var(--s))] lg:w-[calc(704*var(--s))] lg:rounded-[calc(28*var(--s))]">
          <Image
            src="/no-bg-profile.png"
            alt="Huzaifa Ahmed"
            width={1024}
            height={1024}
            className="pointer-events-none absolute bottom-0 left-1/2 h-auto w-[74%] max-w-none -translate-x-1/2 select-none object-contain"
          />
        </div>

        {/* availability chip, overhanging the card's bottom-right corner */}
        <div className="mt-4 flex items-center justify-between gap-4 rounded-[18px] border border-white/70 bg-white/[0.62] p-[18px] shadow-[0_10px_26px_rgba(0,0,0,0.08)] backdrop-blur-[10px] [transform:translateZ(0)] lg:absolute lg:left-[calc(1192*var(--s))] lg:top-[calc(513*var(--s))] lg:z-[4] lg:mt-0 lg:h-[calc(95*var(--s))] lg:w-[calc(297*var(--s))] lg:gap-0 lg:rounded-[calc(18*var(--s))] lg:px-[calc(22*var(--s))] lg:py-0">
          <div>
            <div className="flex items-center gap-[9px] text-[15px] font-bold lg:gap-[calc(9*var(--s))] lg:text-[calc(16*var(--s))]">
              <span className="h-[9px] w-[9px] rounded-full bg-[hsl(var(--yellow))] lg:h-[calc(9*var(--s))] lg:w-[calc(9*var(--s))]" />
              Based in Pakistan
            </div>
        ...
        {/* ---------- divider + stat cards ---------- */}
        <div className="mt-10 hidden h-px bg-[var(--ink-a08)] lg:absolute lg:left-[calc(116*var(--s))] lg:top-[calc(649*var(--s))] lg:z-[2] lg:mt-0 lg:block lg:w-[calc(1388*var(--s))]" />
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:absolute lg:left-[calc(123*var(--s))] lg:top-[calc(672*var(--s))] lg:z-[3] lg:mt-0 lg:flex lg:h-[calc(135*var(--s))] lg:w-[calc(1356*var(--s))] lg:gap-[calc(27*var(--s))]">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="flex items-center gap-[16px] rounded-[20px] border border-[var(--glass-border)] bg-[var(--glass-fill)] p-[20px] shadow-[var(--shadow-sm)] backdrop-blur-[16px] [transform:translateZ(0)] lg:flex-1 lg:gap-[calc(18*var(--s))] lg:rounded-[calc(20*var(--s))] lg:px-[calc(24*var(--s))] lg:py-0"
            >
              ...
              <div>
                ...
                <div className="mt-[8px] h-[3px] w-[30px] bg-[hsl(var(--yellow))] lg:mt-[calc(9*var(--s))] lg:w-[calc(34*var(--s))]" />
              </div>
            </div>
          ))}
        </div>
