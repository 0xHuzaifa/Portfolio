  ...
  return (
    <section style={stageStyle} className={sectionClass}>
      <div style={scale} className={stageClass}>
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute right-[calc(20*var(--s))] top-[calc(90*var(--s))] hidden select-none font-extrabold leading-none tracking-[0.02em] text-[rgba(17,17,17,0.045)] lg:block lg:text-[calc(230*var(--s))]"
        >
          START
        </div>

        {/* ---------- head ---------- */}
        <div className="flex items-center gap-[16px] lg:absolute lg:left-[calc(70*var(--s))] lg:top-[calc(110*var(--s))] lg:z-[5] lg:gap-[calc(16*var(--s))]">
        ...
        <p className="mt-6 max-w-[520px] text-[19px] leading-[1.45] text-[hsl(var(--ink-2))] lg:absolute lg:left-[calc(70*var(--s))] lg:top-[calc(435*var(--s))] lg:z-[5] lg:mt-0 lg:w-[calc(560*var(--s))] lg:max-w-none lg:text-[calc(19*var(--s))] lg:leading-[calc(28*var(--s))]">
        ...
        >
          ...
          <span className="ml-auto flex h-[64px] w-[64px] flex-none items-center justify-center rounded-full bg-white shadow-[0_8px_20px_rgba(0,0,0,0.08)] lg:h-[calc(66*var(--s))] lg:w-[calc(66*var(--s))]">
        ...
        <div className="mt-8 flex items-center gap-[12px] text-[hsl(var(--ink-2))] lg:absolute lg:left-[calc(74*var(--s))] lg:top-[calc(645*var(--s))] lg:z-[5] lg:mt-0 lg:gap-[calc(12*var(--s))]">
        ...
        <a
          ...
          className="mt-2 inline-block border-b-2 border-[hsl(var(--yellow))] pb-[3px] text-[18px] font-bold transition-opacity hover:opacity-70 lg:absolute lg:left-[calc(120*var(--s))] lg:top-[calc(672*var(--s))] lg:z-[5] lg:mt-0 lg:text-[calc(20*var(--s))]"
        >
        ...
        <div
          className={`relative mt-10 overflow-hidden p-[28px] ${panel} lg:absolute lg:left-[calc(832*var(--s))] lg:top-[calc(530*var(--s))] lg:z-[5] lg:mt-0 lg:h-[calc(180*var(--s))] lg:w-[calc(718*var(--s))] lg:rounded-[calc(26*var(--s))] lg:px-[calc(36*var(--s))] lg:py-[calc(30*var(--s))]`}
        >
          <div className="flex items-center gap-[11px] text-[18px] font-bold lg:gap-[calc(11*var(--s))] lg:text-[calc(20*var(--s))]">
            <span className="h-[11px] w-[11px] rounded-full bg-[hsl(var(--yellow))] lg:h-[calc(11*var(--s))] lg:w-[calc(11*var(--s))]" />
            Available for new projects
          </div>
          <p className="mt-[18px] max-w-[340px] text-[16px] leading-[1.45] text-[hsl(var(--ink-2))] lg:mt-[calc(20*var(--s))] lg:max-w-[calc(340*var(--s))] lg:text-[calc(19*var(--s))]">
          ...
          <svg
            ...
            strokeWidth="1"
            className="pointer-events-none absolute right-[calc(44*var(--s))] top-[calc(38*var(--s))] hidden lg:block lg:h-[calc(130*var(--s))] lg:w-[calc(130*var(--s))]"
          >
          ...
          <span className="absolute bottom-[calc(44*var(--s))] right-[calc(52*var(--s))] hidden rounded-full bg-[hsl(var(--yellow))] lg:block lg:h-[calc(12*var(--s))] lg:w-[calc(12*var(--s))]" />
        </div>

        {/* ---------- assurances — design 70,1150 · 1480x132 ---------- */}
        <div
          className={`mt-8 grid grid-cols-1 gap-6 p-[24px] sm:grid-cols-2 ${panel} lg:absolute lg:left-[calc(70*var(--s))] lg:top-[calc(745*var(--s))] lg:z-[4] lg:mt-0 lg:flex lg:h-[calc(105*var(--s))] lg:w-[calc(1480*var(--s))] lg:items-center lg:gap-0 lg:rounded-[calc(26*var(--s))] lg:px-[calc(20*var(--s))] lg:py-0`}
        >
          {assurances.map((item) => (
            <div
              key={item.title}
              className="flex items-center gap-[16px] lg:flex-1 lg:gap-[calc(16*var(--s))] lg:px-[calc(26*var(--s))]"
            >
